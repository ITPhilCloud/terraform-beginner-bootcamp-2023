...
class Home
  ...
  # it is used as an Object-relational mapping (ORM). It has a module within
  # ActiveModel that probides validations. 
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def x_access_code
      # In ruby the last statement is a return, and so the return keyword is optional.
  ...
  def find_user_by_bearer_token
    ...
    # Check if the Authaorization header exists?
